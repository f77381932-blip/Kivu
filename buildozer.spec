...
# ── CRITICAL FIX: entrypoint must be the Java Activity, NOT main.py ──────────
# python-for-android SDL2 bootstrap automatically loads main.py from source.dir
...
# p4a: use stable develop branch instead of master
p4a.branch = develop
p4a.bootstrap = sdl2
